...
if (isset($_POST['simpan'])) {
    ...
    $jml_faktor=mysql_num_rows(mysql_query("SELECT * FROM tbl_faktor"));
    echo $jml_faktor;
                ...
                <div class="panel panel-default">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <?php 
                            $tampil=mysql_query("SELECT * FROM tbl_karyawan ORDER BY id_karyawan asc");
                    ...
                    <?php  
                        $q=mysql_query("SELECT * FROM tbl_faktor ORDER BY id_faktor");
