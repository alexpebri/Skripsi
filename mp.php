        		...
        		<table class="table">
                    ...
                    <tr>
                        ...
                        <?php for($kol=1;$kol<=$jumlah_kolom[$key];$kol++) {
							...
							?>
                        <td><?php if(!empty($nilai_sample[$k][$pos])) { echo "(". $nilai_sample[$k][$pos]; ?>-<?php echo $target[$pos]; ?>)=<strong><?php echo $nilai_gap[$k][$pos];?></strong> <?php } ?></td>
                        <?php } ?>
                    </tr>
                    <?php
							}
        		...
        		<table class="table">
                    ...
                    <tr>
                        ...
                        <?php for($kol=1;$kol<=$jumlah_kolom[$key];$kol++) {
							...
							?>
                        <td><?php if(!empty($nilai_sample[$k][$pos])) { echo $nilai_bobot[$k][$pos]; } ?></td>
                        <?php }
						 ...
						 ?>
                        <td><?php if(!empty($nilai_sample[$k][$pos])) { echo $jum_cf."/".$ccf;?>=<?php echo number_format($ncf,2,",","."); } ?></td>
                        <td><?php if(!empty($nilai_sample[$k][$pos])) {echo $jum_sf."/".$csf;?>=<?php echo number_format($nsf,2,",","."); } ?></td>
                        <td><?php if(!empty($nilai_sample[$k][$pos])) {echo  number_format($nilai_bobot[$k][$key],2,",","."); } ?></td>
                    </tr>
                    <?php
							}
					?>
        ...
        <?php
			...
			?>
            			<tr>
                            	<td><?php echo $nomor++; ?></td>
                                <td><?php echo $nama_karyawan[$k]; ?></td>
                                <td><?php if(!empty($nilai_sample[$k][$pos])) { echo number_format($nilai_akhir[$k],2,",","."); } ?></td>
                            </tr>
            <?php					
							}
		?>
