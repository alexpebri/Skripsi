			...
			<input type=hidden name='id_user' value="<?php  echo $_GET['id_user']; ?>">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label text-right">Level :</label>
							<div class="col-sm-10">
								<input type="text" name="level" value="<?php echo $dataku['level']; ?>" required class="form-control">
							</div>
						</div>
...
if (isset($_POST['simpan'])) {
	...
	$sql="UPDATE tbl_user SET nama='$nama', username='$username', password='$password', level='$level' WHERE id_user='$id_user'";
