					...
					<table class="table">
						...
						<tbody>
							...
							$halaman = 10;
							  ...
							  $result = mysql_query("SELECT * FROM tbl_faktor");
							  $total = mysql_num_rows($result);
							  $pages = ceil($total/$halaman);            
							  $query = mysql_query("SELECT * FROM tbl_faktor, tbl_aspek WHERE tbl_faktor.aspek=tbl_aspek.id_aspek LIMIT $mulai, $halaman")or die(mysql_error);
							  $no =$mulai+1;
