...
$query=mysql_query("select * from tbl_sample, tbl_faktor, tbl_karyawan where tbl_sample.id_sample='$id_sample' AND tbl_sample.faktor=tbl_faktor.id_faktor AND tbl_sample.karyawan=tbl_karyawan.id_karyawan");
